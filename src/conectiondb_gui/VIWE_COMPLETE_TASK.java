...
public class VIWE_COMPLETE_TASK extends javax.swing.JFrame {
     ...
     */
    int id;
    DefaultTableModel dtm  = new DefaultTableModel(); //creating object for the table
    ...
    public VIWE_COMPLETE_TASK(int id) {
        ...
        Image icon =   Toolkit.getDefaultToolkit().getImage("lib/x.png");
     this.setIconImage(icon);
         progress.setModel(dtm); //set the dtm as a model for progress table
        dtm.addColumn("Task Name"); //add the following columns
