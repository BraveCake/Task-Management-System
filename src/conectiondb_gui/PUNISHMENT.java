    ...
    public PUNISHMENT(int id) {
     ...
     this.setIconImage(icon);
      ...
      leader.setID(id);
       ...
       catch(Exception e){ JOptionPane.showMessageDialog(null,"An Error took place while listing the employee punishments","Error",JOptionPane.ERROR_MESSAGE);}finally{database.close();}
...
int row = employees.getSelectedRow();
     ...
     if(penality!=null&&!penality.isBlank())
   database.setPunishment(id,penality.trim() ); 
     if(isUsed)
   viewPunishmnet();
     database.close();
